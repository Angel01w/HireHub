$(document).ready(function () {
    ...
    var table = $('#tabla').DataTable({
        ...
        "columnDefs": [
            ...
            { "name": "LanguageID", "data": "languageID", "targets": 0, "visible": true }, // Columna para IdTipoUsuarios
            { "name": "Name", "data": "name", "targets": 1 }, // Columna para Descripción
            {
