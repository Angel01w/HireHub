$(document).ready(function () {
    ...
    var table = $('#tabla').DataTable({
        ...
        "columnDefs": [
            ...
            { "name": "candidateID", "data": "candidateID", "targets": 0, "visible": true }, // Columna para IdTipoUsuarios
            { "name": "Identification", "data": "identification", "targets": 1, "visible": true }, // Columna para IdTipoUsuarios
            { "name": "Name", "data": "name", "targets": 2 }, // Columna para Descripción
            { "name": "DesiredPosition", "data": "desiredPosition", "targets": 3 }, // Columna para Descripción
            ...
            { "name": "KeyCompetencies", "data": "keyCompetencies", "targets": 6 }, // Columna para Descripción
            { "name": "KeyTrainings", "data": "keyTrainings", "targets": 7 }, // Columna para Descripción
            { "name": "WorkExperience", "data": "workExperience", "targets": 8 }, // Columna para Descripción
            { "name": "RecommendedBy", "data": "recommendedBy", "targets": 9 }, // Columna para Descripción
