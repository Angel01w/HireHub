$(document).ready(function () {
    ...
    var table = $('#tabla').DataTable({
        ...
        "columnDefs": [
            ...
            { "name": "PositionID", "data": "positionID", "targets": 0, "visible": true }, // Columna para IdTipoUsuarios
            { "name": "Name", "data": "name", "targets": 1, "visible": true }, // Columna para IdTipoUsuarios
            { "name": "RiskLevel", "data": "riskLevel", "targets": 2 }, // Columna para Descripción
            {
                "name": "MinimumSalary",
                "data": "minimumSalary",
                "targets": 3,
            ...
            {
                "name": "Status", "data": "status", "targets": 5, // Columna para Estado
                "render": function (data) {
